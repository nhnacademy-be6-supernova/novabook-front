...
public record CreateCategoryCouponTemplateRequest(Long categoryId, String name, long discountAmount, DiscountType discountType,
												  long maxDiscountAmount, long minPurchaseAmount, LocalDateTime startedAt,
												  LocalDateTime expirationAt, Integer usePeriod) {
}