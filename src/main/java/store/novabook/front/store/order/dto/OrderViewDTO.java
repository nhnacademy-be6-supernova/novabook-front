...
@Builder
public record OrderViewDTO(Boolean isPackable, List<GetWrappingPaperResponse> wrappingPapers,
						   List<GetMemberAddressResponse> memberAddresses, List<String> dates, long myPoint,
